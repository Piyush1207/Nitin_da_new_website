...
export const experiences = [
  ...
  },
  {
    ...
    location: "Dubai, UAE",
    description:
      "Distributed Training & Scalable Deployment of LLMs using NVIDIA GPUs on Oracle Kubernetes Engine.",
    technologies: [
      "AI",
      "NVIDIA GPUs",
      "Terraform",
...
export const projects = [
  // ---------------- Oracle Corporation ----------------
  {
    id: 1,
    title:
      "Scaling SGLang on Oracle Kubernetes Engine with RDMA-Connected H100 GPUs",
    description:
      "Discover how to scale SGLang on Oracle Kubernetes Engine using RDMA-connected H100 GPUs for ultra-fast, low-latency LLM inference.",
  ...
  },
  {
    id: 2,
    title:
      "Serving Llama-4-Scout-17B-16E-Instruct on Oracle Kubernetes Engine with NVIDIA NIM",
    description:
      "Learn how NVIDIA NIM simplifies Llama-4-Scout-17B-16E-Instruct deployment on Oracle Kubernetes Engine with the power of NVIDIA Tensor Core H100 GPUs.",
    tech: [
      "OKE",
      "OCI",
      "NIM",
  ...
  },
  {
    id: 3,
    title:
      "Running vLLM on Oracle Kubernetes Engine with RDMA-Connected H100 GPUs",
    description:
      "Learn how vLLM on Oracle Kubernetes Engine harnesses RDMA-connected H100 GPUs for efficient batching and high-performance LLM serving",
    tech: [
      "vLLM",
      "SGLang",
      "NIM",
  ...
  },
  {
    id: 5,
    title:
      "Unlocking the Future – Leveraging NVIDIA GPUs on OCI for Digital Human Creation",
    description:
  ...
  // },
  {
    id: 9,
    title:
      "Accelerating LLaMA 3 Inference: NIM Operator on OKE with Tensor Core NVIDIA H100 GPUs",
    description:
  ...
  // },
  {
    id: 11,
    title:
      "Supercharging AI: Meta Llama-3.3-70B Meets OKE Cluster Accelerated by 8xNVIDIA A10 Tensor Core GPUs",
    description:
  ...
  },
  {
    id: 12,
    title:
      "Unleashing LLaMA 3.1 70B on Oracle Kubernetes Engine with A100 GPUs",
    description:
  ...
  },
  {
    id: 13,
    title:
      "Deploying LLaMA and Gemma‑Instruct models on OCI Infrastructure with NVIDIA A10 GPUs",
    description:
  ...
  // ---------------- TII ----------------
  {
    ...
    description:
      "Developed Video-Falcon, a multi-modal (Image+Video+Sound) generative model inspired by Video-LLaMA.",
  ...
  },
  {
    ...
    description:
      "Reduced LLaMA-7B model size from 14GB (FP16) to 3.5GB (4-bit), achieving 75% compression.",
  ...
  },
  {
    ...
    description:
      "Research project under the supervision of Adi Shamir focused on cryptanalytic extraction of neural networks.",
  ...
  },
  {
    ...
    description:
      "Developed GPU4SNN to accelerate spike propagation for GPU-based Spiking Neural Networks.",
  ...
  },
  {
    id: 18,
    title:
      "GPU4SNN_MedIA: GPU-based Spiking Neural Networks for Medical Image Analysis",
    description:
      "Designed GPU-accelerated spiking neural networks tailored for medical image analysis.",
  ...
  // ---------------- Aarhus University ----------------
  {
    ...
    description:
      "Worked on the EU Project MARVEL for smart cities, focusing on multimodal extreme scale data analytics.",
  ...
  },
  {
    ...
    description:
      "Researched efficient architectures for visual and multimodal deep learning tasks.",
  ...
  // ---------------- University of Córdoba ----------------
  {
    ...
    description:
      "Developed GPU-based methods for pre-operative and intra-operative liver image enhancement and segmentation under the HiPerNav project.",
  ...
  },
  {
    ...
    description:
      "Implemented Pix2Pix GAN for multi-organ segmentation using LITS and 3DIRACDb datasets (collaboration with NTNU).",
...
export const seminars = [
  {
    id: 1,
    description:
      "Delivered expert sessions on “Parallel Computing and Deep Learning for Medical Image Analysis” in AICTE sponsored one week virtual STTP on research methodology and computational techniques (RMCT-2020) Phase 1, 2, and 3 in association with IEEE WIE Affinity group Bombay section",
    date: "7th-12th, 14th-19th, 21th-26th Dec 2020",
  },
  {
    id: 2,
    description:
      "Conducted Student Development Program (SDP) on “Deep Learning: Industry Requirements and Applications”",
  ...
  },
  {
    id: 3,
    description:
      "Conducted SDP on “Machine Learning and Artificial Intelligence, Industry Requirements and Applications”",
    location: "YCCE, Nagpur, India",
    date: "22-23 Dec 2018",
  },
  {
    id: 4,
    description:
      "Conducted SDP on “Development of Embedded Processors using ARM Cortex M0+ Processors”",
  ...
  },
  {
    id: 5,
    description:
      "Assisted Prof. Donald Reay from Heriot-Watt University, UK in conducting Faculty Development Program on DSP for Educators",
  ...
  },
  {
    id: 6,
    description:
      "Conducted a workshop on “Image and Video Processing using Linux, Python and Opencv on Raspberry Pi”",
...
export const techTalks = [
  {
    id: 1,
    description:
      "Delivered a talk on “Deep Learning for IoT” as an expert for the Faculty Development Program on “System Engineering with Applications of Internet of Things” sponsored by AICTE Training and Learning (ATAL)",
  ...
  },
  {
    id: 2,
    description:
      "Delivered expert lecture on ”Accelerating Cancer Diagnosis and Treatment using AI and HPC” as a resource person during the 5-day FDP on Internet of Things: Hardware, Software and Applications, sponsored by AICTE-ATAL",
  ...
  },
  {
    id: 3,
    description:
      "Delivered a talk on “U-Net and YOLO for Liver Cancer Diagnosis” at The Faculty Development Program (FDP)",
...
export const journals = [
  {
    id: 1,
    title:
      "Built an end-to-end observability stack for GPU-powered AI inference.",
    authors: "Nitin Satpute",
    publication: "Technical Contribution at Oracle Corporation",
    year: "2026",
    // link: "https://lnkd.in/p/d68-z68X",
  },
  {
    id: 2,
  ...
  },
  {
    id: 3,
    title:
      "GPU4SNN: Accelerating Spike Propagation for GPU-based SNN Simulations",
    authors: "Nitin Satpute, A. Hambitzer, S. Aljaberi, Najwa Aaraj",
    publication:
      "Springer Nature and International Conference on Parallel Processing and Applied Mathematics",
    year: "2022",
    link: "",
  },
  {
    id: 4,
    title:
      "Cross Modality Guided Liver CT Enhancement for Improved Tumor Segmentation",
    authors:
      "R. Naseem, Z. A. Khan, Nitin Satpute, A. Beghdadi, O. J. Elle, J. Gomez-Luna, F. A. Cheikh",
  ...
  },
  {
    ...
    authors:
      "Nitin Satpute, R. Naseem, E. Pelanis, J. Gomez-Luna, F. A. Cheikh, O. J. Elle, J. Olivares",
  ...
  },
  {
    ...
    authors:
      "Nitin Satpute, R. Naseem, R. Palomar, O. Zachariadis, J. Gomez-Luna, F. A. Cheikh, J. Olivares",
  ...
  },
  {
    ...
    authors:
      "O. Zachariadis, A. Teatini, Nitin Satpute, J. Gomez-Luna, Onur Mutlu, O. J. Elle, J. Olivares",
  ...
  },
  {
    id: 12,
    title:
      "Fast Parallel Cropping for Liver Segmentation and Volume Assessment",
    authors: "Nitin Satpute, J. Gomez-Luna, J. Olivares",
    publication: "",
    year: "2020",
    link: "",
  },
  {
    id: 13,
    title:
      "Segmentation and Classification of MRI Brain Images using Texture Features",
    authors: "A. Shriram, N. Dhabekar, M. Hussain, P. Jumle, Nitin Satpute",
    publication:
      "International Journal of Machine Intelligence and Applications",
    year: "2011",
    link: "",
  },
];
...
export const posters = [
  {
    ...
    authors: "Nitin Satpute, J. Gomez-Luna, J. Olivares",
    event:
      "7th Annual Meeting of the European Computer Assisted Liver Surgery Society (ECALSS)",
  ...
  },
  {
    ...
    authors: "Nitin Satpute, J. Gomez-Luna, J. Olivares",
    event:
      "VII Congreso Científico de Investigadores en Formación de la Universidad de Córdoba",
    location: "Córdoba, Spain",
    date: "Feb 2019",
    link: "",
  },
  ...
  },
  {
    id: 4,
    title:
      "Matrix Multiplication Performance Characterization on GPUs with a Single Point",
    authors: "Nitin Satpute",
  ...
  },
  {
    ...
    event:
      "Eleventh International Summer School on Advanced Computer Architecture and Compilation for High-Performance and Embedded Systems (ACACES 2015)",
    location: "Italy",
    date: "2015",
    link: "",
  },
...
export const conferences = [
  {
    ...
    title: "Polynomial Time Cryptanalytic Extraction of Neural Network Models",
    authors:
      "Isaac A. Canales-Martínez, Jorge Chávez-Saab, Anna Hambitzer, Francisco Rodríguez-Henríquez, Nitin Satpute, Adi Shamir",
    event: "Eurocrypt",
  ...
  },
  {
    ...
    authors:
      "Emanuele Bellini, Nitin Satpute, Juan Grados, Mohamed Rachidi, Joan Daemen, Solane El Hirch",
    event: "LATINCRYPT",
  ...
  },
  {
    ...
    event:
      "1st International Conference on the Paradigm Shifts in Communication, Embedded Systems, Machine Learning and Signal Processing (PCEMS)",
    location: "",
    date: "2022",
    link: "",
  },
  ...
  },
  {
    id: 6,
    title:
      "How High Performance Computing will Revolutionize Next Generation Surgery",
  ...
  },
  {
    ...
    authors:
      "M. Mohammadi, Nitin Satpute, R. Ronge, J. Chandiramani, S.K. Nandy, A. Raihan, T. Verma, R. Narayan, S. Bhattacharya",
  ...
  },
  {
    id: 8,
    title:
      "Tabu Search Based Implementation of Object Tracking using Joint Colour Texture Histogram",
  ...
  },
  {
    ...
    authors: "Nitin Satpute, R. Giorgi",
    event:
      "Eleventh International Summer School on Advanced Computer Architecture and Compilation for High-Performance and Embedded Systems (ACACES)",
    location: "Italy",
    date: "2015",
    link: "",
  },
